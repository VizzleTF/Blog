...
summary: "Как подружить terraform с proxmox и управлять своими виртуальными машинами через terraform"
date: "Sep 15 2025"
draft: false
tags:
  - terraform
...
seoTitle: "Terraform Proxmox: Автоматизация виртуальных машин"
seoDescription: "Полное руководство по интеграции Terraform с Proxmox. Настройка провайдера bpg/proxmox, создание VM через IaC, примеры конфигураций и best practices."
---
...
Очень просто, к каждому приличному провайдеру существует документация, где описаны все сущности, которыми можно с помощью него управлять. Как правило этой документации достаточно. Пример: ![Документация Terraform Proxmox Provider с описанием ресурсов и data sources](/blog/terraform-proxmox/Pasted%20image%2020250915184710.png)
